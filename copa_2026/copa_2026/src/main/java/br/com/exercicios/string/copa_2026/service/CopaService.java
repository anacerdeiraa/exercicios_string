package br.com.exercicios.string.copa_2026.service;

import br.com.exercicios.string.copa_2026.entity.Copa;
import br.com.exercicios.string.copa_2026.repository.CopaRepository;
...
public class CopaService {
    ...
    public Copa editarCopa(Long id, Copa copaAtualizada) {
        ...
        if (copa.isPresent()) {
            ...
            throw new RuntimeException("Copa não encontrada para ID" + id);
        }
    }
}